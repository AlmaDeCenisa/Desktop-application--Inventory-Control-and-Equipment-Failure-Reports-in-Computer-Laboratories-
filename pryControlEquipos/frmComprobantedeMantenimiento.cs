...
{
    public partial class frmComprobantedeMantenimiento : Form
    {
        public frmComprobantedeMantenimiento()
        {
            InitializeComponent();
        }

        private void frmComprobantedeMantenimiento_Load(object sender, EventArgs e)
        {
